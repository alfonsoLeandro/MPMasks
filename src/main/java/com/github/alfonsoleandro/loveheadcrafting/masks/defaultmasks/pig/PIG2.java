...
public class PIG2 extends Mask {

    public PIG2(String skinUrl, String itemName, List<String> itemLore) {
        super(null, "PIG2", skinUrl, itemName, itemLore);
    }

    @Override
    public void start(Player player) {
        Listener multiplyPotion = new MultiplyPotionDuration(player, 1.3);
