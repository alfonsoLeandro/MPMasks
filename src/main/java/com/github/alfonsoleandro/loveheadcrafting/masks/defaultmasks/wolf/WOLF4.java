...
public class WOLF4 extends Mask {

    public WOLF4(String skinUrl, String itemName, List<String> itemLore) {
        super(null, "WOLF4",
                skinUrl,
                itemName,
                itemLore);
    ...
    public void start(Player player) {
        ...
        Listener spawnWolves = new SpawnAttackingWolves(player, 2, 50, plugin.getMessagesYaml().getAccess().getString("wolves name"));
