...
public class OCELOT4 extends Mask {

    public OCELOT4(String skinUrl, String itemName, List<String> itemLore) {
        super(null, "OCELOT4", skinUrl, itemName, itemLore);
    }

    @Override
    public void start(Player player) {
        LoveHeadCrafting plugin = JavaPlugin.getPlugin(LoveHeadCrafting.class);
        Listener fishEvent = new FishRareLoot(plugin, player, 40, maskType);
