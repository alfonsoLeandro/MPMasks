...
public class MOOSHROOM4 extends Mask {

    public MOOSHROOM4(String skinUrl, String itemName, List<String> itemLore) {
        super(null, "MOOSHROOM4", skinUrl, itemName, itemLore);
    }
