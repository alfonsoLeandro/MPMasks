...
public class WOLF2 extends Mask {

    public WOLF2(String skinUrl, String itemName, List<String> itemLore) {
        super(null, "WOLF2",
                skinUrl,
                itemName,
                itemLore);
    ...
    public void start(Player player) {
        ...
        Listener spawnWolves = new SpawnAttackingWolves(player, 1, 40, plugin.getMessagesYaml().getAccess().getString("wolves name"));
