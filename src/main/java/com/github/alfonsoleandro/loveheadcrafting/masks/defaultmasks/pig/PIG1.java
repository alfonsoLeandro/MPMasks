...
public class PIG1 extends Mask {

    public PIG1(String skinUrl, String itemName, List<String> itemLore) {
        super(null, "PIG1", skinUrl, itemName, itemLore);
    }

    @Override
    public void start(Player player) {
        Listener multiplyPotion = new MultiplyPotionDuration(player, 1.1);
