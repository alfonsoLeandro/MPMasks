...
public class OCELOT2 extends Mask {

    public OCELOT2(String skinUrl, String itemName, List<String> itemLore) {
        super(null, "OCELOT2", skinUrl, itemName, itemLore);
    }

    @Override
    public void start(Player player) {
        LoveHeadCrafting plugin = JavaPlugin.getPlugin(LoveHeadCrafting.class);
        Listener fishEvent = new FishRareLoot(plugin, player, 20, maskType);
