...
public class WOLF5 extends Mask {

    public WOLF5(String skinUrl, String itemName, List<String> itemLore) {
        super(null, "WOLF5",
                skinUrl,
                itemName,
                itemLore);
    ...
    public void start(Player player) {
        ...
        Listener spawnWolves = new SpawnAttackingWolves(player, 3, 50, plugin.getMessagesYaml().getAccess().getString("wolves name"));
