...
public class OCELOT3 extends Mask {

    public OCELOT3(String skinUrl, String itemName, List<String> itemLore) {
        super(null, "OCELOT3", skinUrl, itemName, itemLore);
    }

    @Override
    public void start(Player player) {
        LoveHeadCrafting plugin = JavaPlugin.getPlugin(LoveHeadCrafting.class);
        Listener fishEvent = new FishRareLoot(plugin, player, 30, maskType);
