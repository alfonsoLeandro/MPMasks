...
public class SHEEP5 extends Mask {

    public SHEEP5(String skinUrl, String itemName, List<String> itemLore) {
        super(new HashSet<PotionEffect>(){{add(new PotionEffect(PotionEffectType.JUMP, 1, 0));}},
                "SHEEP5",
                skinUrl,
                itemName,
                itemLore);
