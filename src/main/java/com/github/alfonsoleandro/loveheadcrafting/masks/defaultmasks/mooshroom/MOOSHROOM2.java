...
public class MOOSHROOM2 extends Mask {

    public MOOSHROOM2(String skinUrl, String itemName, List<String> itemLore) {
        super(null, "MOOSHROOM2", skinUrl, itemName, itemLore);
    }
