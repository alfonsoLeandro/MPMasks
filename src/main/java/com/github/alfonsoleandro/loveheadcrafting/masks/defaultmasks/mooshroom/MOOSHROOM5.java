...
public class MOOSHROOM5 extends Mask {

    public MOOSHROOM5(String skinUrl, String itemName, List<String> itemLore) {
        super(null, "MOOSHROOM5", skinUrl, itemName, itemLore);
    }
    ...
    public void start(Player player){
        ...
        Listener receiveEffectsWhenHit = new ReceiveEffectsWhenHit(player, new HashSet<PotionEffect>(){{
            ...
            add(new PotionEffect(PotionEffectType.REGENERATION, 100, 2));
        }},45, maskType);
