...
public class YamlFile {
    ...
    private final Map<String, Object> mapRefill;
    ...
    public YamlFile(JavaPlugin plugin,
        ...
        if (mapRefill != null && !fileExists) refillNodes();
    }
    ...
    public void refillNodes() {
        for (Map.Entry<String, Object> mapEntry : mapRefill.entrySet()) {
